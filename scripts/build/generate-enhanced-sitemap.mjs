...
const possibleSitemapPaths = [
  path.join(projectRoot, 'dist', 'sitemap.xml'), // Standard static output
  path.join(projectRoot, '.vercel', 'output', 'static', 'sitemap.xml'), // Vercel static output
  path.join(projectRoot, 'public', 'sitemap.xml'), // Fallback location to generate
];
