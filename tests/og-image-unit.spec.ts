  ...
  test.describe('Font and Typography', () => {
    ...
    test('should handle different title lengths appropriately', async () => {
      const testCases = [
        ...
        { title: 'This is a very long title that should test the font sizing algorithm and ensure that it scales appropriately for longer content', expectedSize: 'small' }
      ];
  ...
  test.describe('Image Generation Quality', () => {
    ...
    test('should generate images with consistent quality', async () => {
      ...
      const contentLengths = responses.map(r => 
        parseInt(r.headers.get('content-length') || '0')
      );
