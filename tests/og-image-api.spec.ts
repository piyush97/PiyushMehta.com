...
test.describe('OG Image API', () => {
  ...
  test.describe('Content Length Testing', () => {
    ...
    test('should handle long title', async () => {
      const url = generateOGImageURL({
        title:
          'This is a very long title that should test how the OG image generation handles extremely long titles that might exceed normal length limits and need to be truncated or handled specially',
    ...
    test('should handle long description', async () => {
      const url = generateOGImageURL({
        ...
        description:
          'This is a very long description that should test how the OG image generation handles extremely long descriptions that might exceed normal length limits and need to be truncated or handled specially in the image generation process',
      });
  ...
  test.describe('Real-world Blog Article Tests', () => {
    test('should generate TypeScript article OG image', async () => {
      const url = generateOGImageURL({
        ...
        description:
          'Discover the game-changing features in TypeScript 5.9 beta including deferred module evaluation, Node.js 20 support, and performance optimizations',
        type: 'article',
        template: 'tech',
        theme: 'dark',
        date: '2025-07-18',
