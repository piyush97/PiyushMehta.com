...
export const GET: APIRoute = async ({ url }) => {
  ...
  const titleFontSize = title.length > 60 ? '38px' : title.length > 40 ? '48px' : title.length > 20 ? '58px' : '68px';
  const descriptionFontSize = isArticle ? '22px' : '26px';
  ...
  try {
    ...
    const getDefaultTemplate = () => React.createElement(
      'div',
      {
        style: {
          display: 'flex',
    ...
    // Minimal template
    const getMinimalTemplate = () => React.createElement(
      'div',
      {
        style: {
          display: 'flex',
    ...
    const getTechTemplate = () => React.createElement(
      'div',
      {
        style: {
          display: 'flex',
    ...
    const getBlogTemplate = () => React.createElement(
      'div',
      {
        style: {
          display: 'flex',
        ...
        React.createElement(
          ...
          [
            ...
            React.createElement(
              ...
              [
                React.createElement('div', { key: 'author' }, 'By Piyush Mehta'),
                date ? React.createElement('div', { key: 'date' }, new Date(date).toLocaleDateString()) : null,
                tags ? React.createElement('div', { key: 'tags' }, tags.split(',')[0]) : null,
              ].filter(Boolean)
            ),
          ]
        ),
