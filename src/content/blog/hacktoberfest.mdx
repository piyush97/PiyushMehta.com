...
date: 2020-10-01
author: 'Piyush Mehta'
banner: '../../assets/hacktoberfest/hacktoberfest.png'
draft: false
...
- Example: <a href="https://github.com/piyush97/piyushmehta.com" target="_blank">This Repository</a>
  <img
    src="../../assets/hacktoberfest/example-repository.png"
    alt="example-repo"
  />
...
- Find the issue with a label of hacktoberfest (Tip: You can even filter it)
  <img
    src="../../assets/hacktoberfest/finding-issues.png"
    alt="finding-issues"
  />
...
- Fork It! (You can get your own fork/copy of the project by using the Fork button)
  ...
  <img src="../../assets/hacktoberfest/fork.jpeg" alt="fork" />
