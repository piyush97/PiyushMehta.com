...
class CodeEnhancer {
  ...
  createHeader(language, codeContent) {
    ...
    langInner.className = 'flex items-center space-x-1';
    const dot = document.createElement('div');
    dot.className = 'w-2 h-2 rounded-full bg-green-400';
    const langSpan = document.createElement('span');
    langSpan.className = 'text-xs text-light-400 uppercase font-mono';
    langSpan.textContent = language;
    langInner.appendChild(dot);
    langInner.appendChild(langSpan);
    languageDiv.appendChild(langInner);
