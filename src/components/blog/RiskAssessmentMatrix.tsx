    ...
    <div className="w-full max-w-6xl mx-auto p-6 bg-surface-100 rounded-lg border border-card-border">
        ...
        {filteredRisks.map((risk) => {
          ...
          return (
            <button
              ...
              className={`w-full text-left p-4 rounded-lg border-2 cursor-pointer transition-all hover:shadow-lg ${getRiskColor(riskLevel)}`}
            >
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-light-800 border border-card-border p-3 rounded-lg">
                  ...
                  <div className="flex items-center">
                    <div
                      className={`size-4 rounded-full ${getStatusColor(selectedRisk.status)} mr-2 shadow-sm`}
                    ></div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="space-y-2">
                    {selectedRisk.mitigation.map((strategy) => (
                      <li key={`strategy-${strategy}`} className="flex items-start">
      ...
      <div className="mt-6 p-4 bg-light-800 rounded-lg border border-card-border">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="flex items-center">
            <div className="size-4 rounded-full bg-accent mr-2 shadow-sm"></div>
            <span className="text-sm text-text-secondary">Avoided</span>
          </div>
          <div className="flex items-center">
            <div className="size-4 rounded-full bg-light-600 mr-2 shadow-sm"></div>
            <span className="text-sm text-text-secondary">Mitigated</span>
          </div>
          <div className="flex items-center">
            <div className="size-4 rounded-full bg-danger mr-2 shadow-sm"></div>
            <span className="text-sm text-text-secondary">Occurred</span>
          </div>
          <div className="flex items-center">
            <div className="size-4 rounded-full bg-light-500 mr-2 shadow-sm"></div>
