...
const componentDetails: Record<string, { title: string; description: string; specs: string[] }> = {
  application: {
    ...
    <div className="w-full max-w-6xl mx-auto p-6 bg-surface-100 rounded-lg border border-card-border">
      ...
      <div className="relative bg-white rounded-lg border border-card-border p-6 mb-6 overflow-x-auto">
        <svg width="600" height="500" className="min-w-full">
          {/* Render Connections */}
          {currentPhase.connections.map((connection) => {
            ...
            <div className="p-6">
              {(() => {
                ...
                const details = component
                  ? (componentDetails[component.type] ?? {
                      title: 'Component',
                    ...
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1">
                        {details.specs.map((spec) => (
                          <li key={`spec-${spec}`} className="flex items-start">
        ...
        <div className="p-4 bg-card-bg rounded-lg border border-card-border">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center">
              <div className="size-4 bg-blue-100 border border-blue-300 rounded mr-2"></div>
              <span>Application Servers</span>
            </div>
            <div className="flex items-center">
              <div className="size-4 bg-red-100 border border-red-300 rounded mr-2"></div>
              <span>Legacy Database</span>
            </div>
            <div className="flex items-center">
              <div className="size-4 bg-green-100 border border-green-300 rounded mr-2"></div>
              <span>New Aurora Database</span>
            </div>
            <div className="flex items-center">
              <div className="size-4 bg-yellow-100 border border-yellow-300 rounded mr-2"></div>
