...
const Header: FC = () => {
  ...
  return (
    <>
      <MobileSheet />
      <header className="sticky top-0 z-50 w-full border-0 container px-4 md:px-6 dark:bg-black bg-white backdrop-blur bg-opacity-60 dark:backdrop-blur dark:bg-opacity-60">
        <Menubar className="hidden bg-transparent lg:flex container h-14 max-w-screen-2xl items-center border-0">
          <Link href="/" className="text-primary">
            <MenubarLabel className="text-md sm:text-lg md:text-xl lg:text-2xl font-medium">
              {"∆"} {AUTHOR_NAME}
            </MenubarLabel>
          </Link>
