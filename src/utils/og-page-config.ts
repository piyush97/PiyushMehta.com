...
export const PAGE_CONFIGS: Record<string, PageOGConfig> = {
  ...
  '/': {
    ...
    description:
      'Expert React.js, Node.js developer in Canada. 5+ years experience building scalable web applications, enterprise software, and providing technical consulting.',
  ...
  '/about': {
    ...
    description:
      'Senior Software Engineer with 5+ years of experience in Canada. Passionate about React.js, Node.js, system architecture, and building teams.',
    template: 'professional',
    theme: 'warm',
  ...
  '/services': {
    ...
    description:
      'Professional software engineering services: React.js development, Node.js APIs, system architecture, technical consulting, and enterprise solutions.',
    template: 'professional',
    theme: 'corporate',
  ...
  '/projects': {
    ...
    description:
      'Showcase of innovative software projects, open source contributions, and technical solutions built with React.js, Node.js, and modern technologies.',
    template: 'tech',
    theme: 'neon',
  ...
  '/contact-me': {
    ...
    description:
      'Get in touch for software development projects, technical consulting, architecture reviews, or collaboration opportunities.',
    template: 'minimal',
    theme: 'ocean',
  ...
  '/resume': {
    ...
    description:
      'Comprehensive resume showcasing 5+ years of software engineering experience, technical skills, achievements, and professional background.',
    template: 'professional',
    theme: 'corporate',
  ...
  '/videos': {
    ...
    description:
      'Educational videos, tech talks, and software engineering content covering React.js, Node.js, system design, and industry best practices.',
    template: 'gradient',
    theme: 'retro',
  ...
  '/uses': {
    ...
    description:
      'Complete overview of my software development setup, tools, technologies, hardware, and resources that power my daily work.',
    template: 'tech',
    theme: 'dark',
  ...
  '/blog': {
    ...
    description:
      'In-depth articles on software engineering, React.js, Node.js, system design, performance optimization, and industry best practices.',
    template: 'modern',
    theme: 'dark',
  ...
  '/react-developer': {
    ...
    description:
      'Specialized React.js development services: component architecture, state management, performance optimization, and modern web applications.',
    template: 'tech',
    theme: 'neon',
  ...
  '/privacy-policy': {
    ...
    description:
      'Comprehensive privacy policy outlining how we collect, use, and protect your personal information and data.',
    template: 'minimal',
    theme: 'light',
  ...
  '/terms-of-service': {
    ...
    description:
      'Terms and conditions for using this website and engaging with our software development services.',
    template: 'minimal',
    theme: 'light',
  ...
  '/offline': {
    ...
    description:
      'You are currently offline. Please check your internet connection to access the latest content.',
    template: 'minimal',
    theme: 'dark',
...
export function generatePageConfig(
  ...
  if (pathname.startsWith('/blog/')) {
    return {
      ...
      description:
        customDescription ||
        'Deep dive into software engineering concepts, best practices, and real-world solutions.',
      template: 'modern',
      theme: 'dark',
  ...
  if (pathname.includes('project')) {
    return {
      ...
      description:
        customDescription ||
        'Innovative software project demonstrating modern development practices and technologies.',
      template: 'tech',
      theme: 'neon',
